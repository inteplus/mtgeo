...
class GeometricObject(object):
    ...
    A GeometricObject is a geometric object which lives in a d-dimensional Euclidean space. It can be a point, a point set, a polygon, a circle, a sphere, a parallelogram, a paralleloid, etc. This class represents the base class, in which the only class method available is `ndim`, telling the number of dimensions. The user needs to implement `ndim`, or use some mixin classes like `TwoD` or `ThreeD`.
    '''
