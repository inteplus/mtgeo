...
def moment_x(poly):
    ...
    >>> from geomt.polygon2d import moment_x
    >>> import numpy as np
...
def moment_y(poly):
    ...
    >>> from geomt.polygon2d import moment_y
    >>> import numpy as np
...
def moment_xy(poly):
    ...
    >>> from geomt.polygon2d import moment_xy
    >>> import numpy as np
    >>> poly = np.array([[3,3],[2,2],[3,1]])
...
def moment_xx(poly):
    ...
    >>> from geomt.polygon2d import moment_xx
    >>> import numpy as np
    >>> poly = np.array([[3,3],[2,2],[3,1]])
...
def moment_yy(poly):
    ...
    >>> from geomt.polygon2d import moment_yy
    >>> import numpy as np
    >>> poly = np.array([[3,3],[2,2],[3,1]])
...
def to_moments2d(poly):
    ...
    :Examples:
    >>> from geomt.polygon2d import to_moments2d
    >>> import numpy as np
    >>> poly = np.array([[3,3],[2,2],[3,1]])
    >>> m = to_moments2d(poly)
    >>> round(m.m0, 3)
